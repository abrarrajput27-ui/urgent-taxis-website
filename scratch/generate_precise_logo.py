...
# Side Window Logo - Front Left Window
# Make it fit perfectly on the front window
target_width = 250
...
# Rotate slightly to align with the window sill
logo_side_normal = logo_side.rotate(6, expand=True)

# Paste on normal car (front door window)
x_normal = 380
y_normal = 160
...
logo_side_flipped = logo_side.rotate(-6, expand=True)
...
print(f"Created precise window logos for {out_normal} and {out_flipped}")
