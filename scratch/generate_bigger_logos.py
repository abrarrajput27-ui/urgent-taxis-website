...
# Side Window Logo
# Make it much bigger to be "proper visible"
target_width = 350
...
logo_bonnet_normal = logo_bonnet.rotate(-15, expand=True) 
x_bonnet_normal = 160
y_bonnet_normal = 210
...
print(f"Created bigger logos for {out_normal} and {out_flipped}")
