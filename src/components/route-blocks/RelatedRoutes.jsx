      ...
      <div className="w-full px-4 sm:px-8 lg:px-12 mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {relatedRouteObjects.map((r, index) => (
            ...
            >
              <div>
                <h4 className="font-bold text-slate-800 group-hover:text-blue-600 transition-colors text-sm">{r.route || r.seoTitle}</h4>
                <p className="text-xs text-slate-500 mt-1">{r.distance || 'Premium Taxi'}</p>
              </div>
