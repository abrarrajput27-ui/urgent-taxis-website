    ...
    <section className="pt-8 pb-12 bg-white relative">
      <div className="w-full px-4 sm:px-8 lg:px-12 mx-auto relative z-10">
        <div className="bg-[#1746a2] bg-gradient-to-r from-[#1746a2] to-[#0c3182] rounded-xl px-4 sm:px-6 pt-[100px] pb-6 md:px-8 md:py-8 flex flex-col md:flex-row items-center justify-between relative shadow-2xl mt-20 md:mt-12">
          ...
          <div className="absolute -top-16 md:top-1/2 left-1/2 md:left-auto md:-right-12 -translate-x-1/2 md:translate-x-0 md:-translate-y-[45%] w-[380px] max-w-[100vw] md:max-w-none md:w-[680px] z-30 pointer-events-none">
            <img 
