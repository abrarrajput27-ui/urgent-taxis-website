  ...
  if (success && !blockedUrl) {
    return (
      <div className="p-8 text-center flex flex-col items-center justify-center min-h-[450px]">
        <CheckCircle2 className="w-20 h-20 text-[#00914d] mb-4 animate-bounce" />
                      ...
                      {fare.tripType === 'One Way' ? (
                        <div className="space-y-3 bg-white p-4 rounded-xl border border-gray-200">
                          ...
                          <div className="flex justify-between items-center pt-3 border-t border-dashed border-gray-200 mt-2">
                            ...
                            <span className="font-black text-[18px] text-[#00914d]">₹{fare.totalFare}</span>
                          </div>
                        ...
                        <div className="space-y-2 bg-white p-4 rounded-xl border border-gray-200">
                          <h4 className="font-bold text-gray-900 text-[13px] flex items-center border-b border-gray-100 pb-2 mb-2">
                            <CreditCard className="w-4 h-4 mr-1.5 text-blue-600" /> Package: {localPackage || '8hr/80km'}
                          </h4>
                          
                          <div className="flex justify-between text-[12px]">
                            <span className="text-gray-600">Included Limits</span>
                            <span className="font-semibold text-gray-900">{localPackage ? localPackage.split('/').join(' & ') : '80 km & 8 hr'}</span>
                          </div>

                          <div className="flex justify-between text-[12px]">
                            <span className="text-gray-600">Post Limit: Extra KM</span>
                            <span className="font-semibold text-gray-900">₹{fare.perKmRate}/km</span>
                          </div>

                          <div className="flex justify-between text-[12px]">
                            <span className="text-gray-600">Post Limit: Extra Hour</span>
                            <span className="font-semibold text-gray-900">
                          ...
                          <div className="bg-yellow-50 text-yellow-800 p-2 rounded-lg text-[10px] leading-tight flex items-start border border-yellow-100 mt-2">
                            <AlertCircle className="w-3 h-3 mr-1 flex-shrink-0 mt-0.5 text-yellow-600" />
                            <span>Extra KM & hours calculated post-journey. Tolls/Parking extra.</span>
                          </div>
                        </div>
                      )}
