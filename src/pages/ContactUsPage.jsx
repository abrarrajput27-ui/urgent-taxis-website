...
export default function ContactUsPage() {
  ...
  const whatsapp = currentLocation.whatsapp || phone;
  ...
  const handleWhatsApp = () => {
    const message = `Hi Urgent Taxis, I am looking to book a taxi from ${city}.\n\nFrom ${city} (${window.location.hostname})`;
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col font-sans">
      <SEOHead 
        title={`Contact Urgent Taxis ${city} - Booking & Support`}
        description={`Get in touch with Urgent Taxis ${city} for outstation bookings, local rentals, and airport transfers. 24/7 support.`}
        canonicalUrl="https://urgenttaxis.com/contact"
      />
      <Header />
      ...
      <main className="flex-grow pt-[60px] lg:pt-[70px]">
        <div className="bg-[#0B132B] text-white py-16 px-4 relative overflow-hidden flex flex-col items-center justify-center text-center min-h-[300px]">
          <div className="max-w-[800px] mx-auto relative z-10 w-full">
            <h1 className="text-3xl md:text-5xl font-black mb-4 leading-tight">Contact Urgent Taxis</h1>
            <p className="text-gray-300 text-lg font-medium max-w-2xl mx-auto">
              We are here to assist you 24/7. Get in touch with our booking center for quotes, reservations, or support.
            </p>
            ...
            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-xl flex flex-col justify-between">
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`tel:${phone}`} className="text-xl font-bold text-blue-600 hover:text-blue-700">
                      {phone.replace('+91', '+91 ')}
                    </a>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={handleWhatsApp()} target="_blank" rel="noopener noreferrer" className="text-xl font-bold text-[#00914d] hover:text-[#00914d] flex items-center">
                      {whatsapp.replace('+91', '+91 ')} <span className="ml-2 bg-[#25D366]/10 text-[#25D366] text-[10px] font-black px-2 py-0.5 rounded uppercase">Online</span>
                    </a>
                  </div>
                </div>
              ...
              <div className="pt-8 border-t border-gray-100 mt-8">
                ...
                <div className="flex space-x-3">
                  <a href="https://www.facebook.com/p/Urgent-Taxis-100094316769562/" target="_blank" rel="noopener noreferrer" className="bg-[#1877F2] text-white p-2.5 rounded-full hover:opacity-85 transition-opacity" aria-label="Facebook">
                    <FacebookIcon className="w-5 h-5" />
                  </a>
                  <a href="https://www.instagram.com/urgent.taxis" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-tr from-[#FD1D1D] via-[#E1306C] to-[#833AB4] text-white p-2.5 rounded-full hover:opacity-85 transition-opacity" aria-label="Instagram">
                    <InstagramIcon className="w-5 h-5" />
                  </a>
                  <a href="https://www.youtube.com/@urgenttaxis" target="_blank" rel="noopener noreferrer" className="bg-[#FF0000] text-white p-2.5 rounded-full hover:opacity-85 transition-opacity" aria-label="YouTube">
