      ...
      <div className="min-h-screen bg-slate-50 flex flex-col pt-32 pb-20">
        <div className="w-full max-w-3xl mx-auto px-4 text-center">
          <div className="bg-white rounded-3xl shadow-xl p-10 md:p-16 border border-slate-100">
            <h1 className="text-4xl md:text-5xl font-black text-[#3b2b98] mb-6">Coming Soon</h1>
...
Please share the availability and exact quote.`;
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-blue-200">
      <SEOHead 
        title={route.seoTitle || route.seo?.title}
        description={route.seoDescription || route.seo?.metaDescription}
        canonicalUrl={`https://urgenttaxis.com/${route.slug}`}
        schemas={schemas}
      />
      <Header />
